...
const SignUp = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-purple-200 to-purple-300 p-4 md:p-0">
      ...
      />
      <div className="absolute top-2 left-4 md:left-8 z-[1002]">
        <Image
      ...
      >
        ...
        <div
          className="md:hidden absolute top-0 left-0 w-full h-16 bg-[#313053] z-[1001] flex justify-center items-center"
          style={{
        ...
        <div className="form-container w-full md:w-1/2 md:ml-auto h-full flex flex-col justify-center items-center bg-white p-4 md:p-8 pt-20 md:pt-8 z-[1001]">
          <form
